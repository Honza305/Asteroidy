...
import pyglet
from pyglet.window.key import DOWN, UP , MOD_CTRL, MOD_SHIFT, LEFT, RIGHT
...
def tiktak(t):
    ...
    # posun
    sprite.x = sprite.x + rychlost*sin(pi*uhel/180)
    sprite.y = sprite.y + rychlost*cos(pi*uhel/180)
